...
>
  ...
  <Grid item xs={12} sm={6} md={6}>
    <div className="pt-1 pb-2 rounded-lg" style={{ height: '95%',background:'white'}}>
      <StackedBarchart />
    </div>
  </Grid>
  ...
  {/* Simple Bar Chart */}
  <Grid item xs={12} sm={6} md={6}>
    <div className="pt-1 pb-2 rounded-lg"style={{ height: '95%', background:'white' ,width:'fit' }}>
      <BarChart />
    </div>
  </Grid>
  ...
  <div className="" style={{ height: '90%', background:'white' ,width:'fit', }}>
