const htmlBody = (token, date) => {
  return `
      ...
      border-radius: 2px;
      box-shadow: 0 4px 12px rgba(0, 28, 107, 0.1);
              ...
              <div class="email-card">
                  ...
                  <div class="content">
                      ...
                      <div class="otp-container">
                          <div class="otp-container">
<a href="http://localhost:8000/api/yes?token=${token}&action=YES" class="btn btn-yes">YES</a>
<a href="http://localhost:8000/api/no?token=${token}&action=NO" class="btn btn-no">NO</a>
  </div>
