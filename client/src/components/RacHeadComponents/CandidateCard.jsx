...
const CandidateCard = ({ candidate }) => {
  ...
  return (
    <div style={{ boxShadow: "rgba(0, 0, 0, 0.1) 0px 1px 3px 0px, rgba(0, 0, 0, 0.06) 0px 1px 2px 0px" }} className="flex flex-col justify-between p-4 border border-gray-300 rounded-lg bg-white w-64 min-w-[256px] max-w-[300px] h-full">
      <span>
