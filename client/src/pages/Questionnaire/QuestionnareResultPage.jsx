    ...
    <main className="h-screen bg-[#eee] flex justify-center items-center">
      <div className="w-[65%] px-3 py-6 bg-white rounded-lg shadow-sm flex flex-col gap-y-12">
        ...
        <Grid container spacing={2} columns={16}>
          <Grid size={10}  sx={{borderRight:"1px solid #f4f4f4", borderRadius:"10px"}}>
            ...
            <h1 className="mt-8 text-center text-2xl font-semibold">
              <span className="px-5 py-4 border border-[#f4f4f4] rounded-md" style={{boxShadow:"rgba(0, 0, 0, 0.05) 0px 1px 2px 0px"}}>
          ...
          <Grid size={6}>
            ...
            <h2 className="text-[#0e8cca] font-medium text-lg">Score Breakdown</h2>
            <div className="flex flex-col gap-y-6 mt-6">
                <span className="flex items-center justify-between bg-[#f9f9f9] px-5 py-3 rounded-md mx-3" style={{boxShadow:"rgba(0, 0, 0, 0.04) 0px 3px 5px"}}>
            ...
            <button className="mt-6 w-full font-normal text-[#0e8cca]">Go back to dashboard</button>
          </Grid>
        </Grid>
      </div>
    </main>
