  ...
  return (
    <div className="min-h-[34vh] min-w-[32vh] bg-[#F6F8FB] rounded-lg shrink-0 p-4 flex flex-col gap-y-5">
      ...
      <div className="flex items-center gap-x-4">
        ...
        <h1 className="font-semibold text-[#3C3C3C]">AI in Defence</h1>
      </div>

      <div className="flex flex-col gap-y-3">
        <span className="flex justify-start items-center gap-x-4 pl-2 text-[#464646]">
          <HiOutlineOfficeBuilding />
          <p className="font-medium text-base">Department of AI & ML</p>
        </span>
        ...
        <span className="flex justify-start items-center gap-x-4 pl-2 text-[#464646]">
          <MdGroups />
          <p className="font-medium text-base">30 Candidates</p>
        </span>
      </div>
