  ...
  const SideNavbar = () => {
    ...
    return (
      <aside
        className={`no-scrollbar relative flex flex-col items-center pt-8 bg-white transition-all duration-300 ${isSidebarCollapsed ? "max-w-[7%] w-full" : "max-w-[16vw] w-full"
